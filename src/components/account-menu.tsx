...
export function AccountMenu() {
  ...
  const { mutateAsync: signOutFn, isPending: inSigningOut } = useMutation({
    mutationFn: signOut,
    onSuccess: () => {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          <DropdownMenuItem
            ...
            disabled={inSigningOut}
          >
            <Button
              className="w-full justify-start bg-[transparent] hover:border-[transparent!important]"
              onClick={() => signOutFn()}
            >
